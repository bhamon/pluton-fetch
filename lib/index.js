  ...
  return new Promise((_resolve, _reject) => {
    ...
    function onResponse(_out) {
      ...
      Object.defineProperties(proto, {
        ...
        text: {enumerable: true, value: async () => await streamText(stream)},
        json: {enumerable: true, value: async () => await streamJSON(stream)}
      });
...
function createSession(_url, _options) {
  return new Promise((_resolve, _reject) => {
    ...
    function onConnect() {
      ...
      Object.defineProperties(proto, {
        request: {enumerable: true, value: async _in => await sessionRequest(session, _in)},
        close: {enumerable: true, value: async () => await sessionClose(session)}
      });
...
async function fetch(_url, _options = {}) {
  ...
  try {
    ...
    Object.defineProperties(proto, {
      headers: {enumerable: true, value: () => res.headers},
      status: {enumerable: true, value: () => res.status},
      ok: {enumerable: true, value: () => res.ok},
      text: {enumerable: true, value: autoClose(async () => await res.text())},
      json: {enumerable: true, value: autoClose(async () => await res.json())}
    });
